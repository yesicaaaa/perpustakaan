<nav class="navbar navbar-expand-lg navbar-light bg-blue sticky-top">
  ...
  <div class="sidenav">
    ...
    <div class="menu-list">
      <ul>
        @if(Auth::user()->hasRole('admin'))
        <li class="{{($url == 'dashboardAdmin') ? 'active' : ''}}"><a href="/dashboardAdmin" id="dashboard"><i class="fa fa-fw fa-home"></i> Dashboard</a></li>
        ...
        <li class="{{($url == 'historyPengembalian') ? 'active' : ''}}"><a href="/historyPengembalian" id="historyPengembalian"><i class="fa fa-fw fa-history"></i>History Pengembalian</a></li>
        @endif
      </ul>
    </div>
  </div>
